...
public class GuardianRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usersRef = FirebaseDatabase.getInstance().getReference("Guardians");
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            if (user != null) {
                                ...
                                Toast.makeText(GuardianRegister.this,
                                        "Registration successful",
                                        Toast.LENGTH_SHORT).show();

                                startActivity(new Intent(GuardianRegister.this, GuardianLogin.class));
                                finish();
                            }
                        } else {
                            Toast.makeText(GuardianRegister.this,
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(GuardianRegister.this, GuardianLogin.class);
    ...
    private void saveUserData(FirebaseUser user, String fName, String mName,
        ...
        usersRef.child(userId).setValue(userMap)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(GuardianRegister.this, "User data saved successfully", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(GuardianRegister.this, "Failed to save user data: " + e.getMessage(),
                            Toast.LENGTH_SHORT).show();
                });
    }
}